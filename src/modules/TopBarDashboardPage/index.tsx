        ...
        <>
            <div className="container-fluid" style={{ backgroundColor: '#ededed !important', boxSizing:'border-box',paddingLeft:'32px' }}>
                <div className="row mt-4" >
                    <div className="col-md" style={{ marginTop: ' 8px', alignSelf:'center', height:'50px' }}>
                        <div className="input-group mb-3" >
                        <TextField  id="outlined-basic" variant="outlined" style={{borderRadius:'25px',borderColor:'transparent',width:'30%', backgroundColor:'#f4f4f5', fontStyle:'none'}} placeholder=' Search' InputProps={{startAdornment:(<i className="bi bi-search"></i>), disableUnderline:true}}></TextField>
                        </div>
                    </div>
