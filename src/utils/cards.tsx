...
export const Cards=({icon,title,text,button, index, colorIcon = '', colorBackground = ''})=> {
  ...
  return (
    ...
    <div style={{minWidth: '342px', maxWidth: '450px', position: 'relative', marginTop: 60, boxShadow:'0px 0px 24px -18px rgba(0,0,0,1)', minHeight:200}}>
      <div style={{width: '106px', height: '106px', backgroundColor: colorBackground, borderRadius: '50%', display: 'flex', alignContent: 'center', justifyContent: 'center', alignItems: 'center', position: 'absolute', top: 'calc(-68px)', left: 'calc(50% - 53px)'}}>
        <i style={{fontSize: '48px', color: colorIcon}} className={icon}></i>
      </div>
      <div style={{backgroundColor: 'white', padding: '63px 15px', paddingBottom: '20px', color: 'black', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '230px', borderRadius:'10px'}}>
