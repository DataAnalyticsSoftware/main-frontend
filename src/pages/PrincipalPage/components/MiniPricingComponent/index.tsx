...
export const MiniPricingComponent=({price, title, description, link})=> {
  return (
    <Box style={{backgroundColor:'#111827', height:'80px', borderRadius:'25px', display:'flex',alignItems:'center', color:'white', marginBottom:'6px'}}>
        <Grid item xs={4}>
        ...
        <Grid item xs={2} style={{textAlign:'left', backgroundColor:'#4F46E5', borderRadius:'25px', height:'100%', paddingTop:'10px',}}>
