...
export const CenterTextComponent = ({dataInformation, index}: ITextProps) => {
    return <div key={index} style={{ width: '100%', height: '115px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', paddingLeft: '100px', paddingRight: '100px' }}>
